...
//      ),
                      ...
                      [
                        CachedNetworkImage(
                          ...
                          placeholder: (context, url) => Container(
                            child:
                                SpinKitPulse(size: 200.0, color: Colors.white),
                          ),
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 16.0, right: 16.0),
                          child: buildKeywords(
                              state.movieDetail.keywords.keywords),
                        ),
                        Container(
                          margin: EdgeInsets.only(bottom: 16.0, top: 16.0),
                          color: Colors.white24,
                      ...
                      [
                        Column(
                          children: <Widget>[
                            ...
                            Expanded(
                              child: Container(
                                child: _buildTopCastList(
                                    state.movieDetail.credits.cast),
                              ),
                            ),
                          ],
                        ),
  ...
  Widget _buildTopCastList(List<Cast> cast) {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return _buildTopCastItem(cast[index]);
        });
  }
